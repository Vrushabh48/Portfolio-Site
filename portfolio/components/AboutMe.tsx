  ...
  return (
    <div className="grid lg:grid-cols-2 grid-cols-1 lg:ml-16 lg:mr-16 ml-8 mr-8 mt-10 gap-10 mb-12">
      <div className="w-[350px] h-[91px] lg:ml-10 lg:mt-20">
        <h1 className={`${bebasNeue.variable} font-sans text-white lg:text-7xl text-5xl hover:underline hover:decoration-lime-400 hover:transition-all hover:duration-500`}>About Me</h1>
      </div>
